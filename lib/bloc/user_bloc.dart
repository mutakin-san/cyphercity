...
class UserBloc extends Bloc<UserEvent, UserState> {
  ...
  UserBloc(this._repository) : super(UserInitial()) {
    ...
    on<UserRegister>((event, emit) async {
      ...
      final result = await _repository.register(email: event.email, name: event.name, username: event.username, noHp: event.noHp, password: event.password, confirmPassword: event.confirmPassword, statusSekolah: event.statusSekolah);
